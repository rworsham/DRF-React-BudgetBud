...
from .views import UserListCreateView, UserCreateView, UserRetrieveUpdateDestroyView, FamilyView, CategoryViewSet, \
    ...
    FamilyAddMemberViewSet, LoginView, FamilyOverviewView, FamilyHistoryView, CategoryDataView
...
urlpatterns = [
    ...
    path('api/family/history/', FamilyHistoryView.as_view(), name='family-history'),
